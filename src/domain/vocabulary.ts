export type Dataset = 'vocabulary' | 'singular-plural' | 'participles' | 'writing' | 'custom'
...
export const DATASET_NAMES: Record<Dataset,string> = { vocabulary:'普通词汇', 'singular-plural':'单复数', participles:'分词形式', writing:'写作常用', custom:'我的词库' }
