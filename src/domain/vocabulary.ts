export type Dataset = 'vocabulary' | 'singular-plural' | 'participles' | 'writing' | 'writing-singular-plural' | 'task2-core-concepts' | 'dictation' | 'custom'
...
export const DATASET_NAMES: Record<Dataset,string> = { vocabulary:'普通词汇', 'singular-plural':'单复数', participles:'分词形式', writing:'写作常用', 'writing-singular-plural':'写作-单复数', 'task2-core-concepts':'task2-底层概念', dictation:'句子默写', custom:'我的词库' }
